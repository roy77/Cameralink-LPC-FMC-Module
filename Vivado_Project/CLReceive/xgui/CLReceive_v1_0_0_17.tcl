...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S00_AXI_DATA_WIDTH" -parent ${Page_1}
  ipgui::add_param $IPINST -name "C_S00_AXI_ADDR_WIDTH" -parent ${Page_1}
  ipgui::add_static_text $IPINST -name "C_S00_AXI_BASEADDR" -parent ${Page_1} -text {C_S00_AXI_BASEADDR: 0xFFFFFFFF}
  ipgui::add_static_text $IPINST -name "C_S00_AXI_HIGHADDR" -parent ${Page_1} -text {C_S00_AXI_HIGHADDR: 0x00000000}
  ipgui::add_param $IPINST -name "C_M00_AXIS_TDATA_WIDTH" -parent ${Page_1}
  ipgui::add_param $IPINST -name "C_M00_AXIS_START_COUNT" -parent ${Page_1}
