...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set G_SERFC [ create_bd_port -dir I G_SERFC ]
  set G_SERTC [ create_bd_port -dir O -type data G_SERTC ]
  set LED [ create_bd_port -dir O -from 7 -to 0 LED ]
  set O2_CC [ create_bd_port -dir O -from 3 -to 0 -type clk O2_CC ]
  set O2_CLK [ create_bd_port -dir I -type clk O2_CLK ]
  set O2_D [ create_bd_port -dir I -from 27 -to 0 -type data O2_D ]
  set SW [ create_bd_port -dir I -from 7 -to 0 SW ]

  # Create instance: CLReceive_0, and set properties
  set CLReceive_0 [ create_bd_cell -type ip -vlnv dhbw:user:CLReceive:1.0.2.7 CLReceive_0 ]
  ...
  set_property -dict [ list CONFIG.c_include_mm2s {0} CONFIG.c_include_s2mm {1} CONFIG.c_include_s2mm_sf {0} CONFIG.c_include_sg {0}  ] $axi_dma_2
  ...
  set_property -dict [ list CONFIG.FIFO_DEPTH {16} CONFIG.HAS_TKEEP {1} CONFIG.HAS_TLAST {1} CONFIG.HAS_TSTRB {0} CONFIG.IS_ACLK_ASYNC {1} CONFIG.TDATA_NUM_BYTES {4}  ] $axis_data_fifo_1

  # Create instance: proc_sys_reset, and set properties
  set proc_sys_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset ]
  set_property -dict [ list CONFIG.C_AUX_RESET_HIGH {0}  ] $proc_sys_reset

  # Create instance: proc_sys_reset1, and set properties
  set proc_sys_reset1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset1 ]
  set_property -dict [ list CONFIG.C_AUX_RESET_HIGH {0}  ] $proc_sys_reset1
  ...
  set_property -dict [ list CONFIG.PCW_ACT_ENET0_PERIPHERAL_FREQMHZ {125} \
CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {96} CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {209} \
CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {50} CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {50} \
CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {209} CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {188} \
CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {50} CONFIG.PCW_ACT_TPIU_PERIPHERAL_FREQMHZ {10} \
CONFIG.PCW_ACT_UART_PERIPHERAL_FREQMHZ {50} CONFIG.PCW_APU_PERIPHERAL_FREQMHZ {666.666667} \
CONFIG.PCW_CLK0_FREQ {96461533} CONFIG.PCW_CLK1_FREQ {209000000} \
CONFIG.PCW_CLK2_FREQ {50160000} CONFIG.PCW_CLK3_FREQ {50160000} \
...
CONFIG.PCW_EN_CLK2_PORT {1} CONFIG.PCW_EN_EMIO_TTC0 {1} \
...
CONFIG.PCW_EN_USB0 {1} CONFIG.PCW_FCLK_CLK1_BUF {true} \
CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {100.000000} CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {200.000000} \
...
CONFIG.PCW_IRQ_F2P_INTR {1} CONFIG.PCW_MIO_0_IOTYPE {LVCMOS 3.3V} \
...
CONFIG.PCW_MIO_6_SLEW {fast} CONFIG.PCW_MIO_7_IOTYPE {LVCMOS 3.3V} \
CONFIG.PCW_MIO_7_SLEW {slow} CONFIG.PCW_MIO_8_IOTYPE {LVCMOS 3.3V} \
CONFIG.PCW_MIO_8_SLEW {fast} CONFIG.PCW_MIO_9_IOTYPE {LVCMOS 3.3V} \
CONFIG.PCW_MIO_9_PULLUP {disabled} CONFIG.PCW_MIO_9_SLEW {slow} \
CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#UART 1#UART 1#GPIO#GPIO#Enet 0#Enet 0} CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#wp#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
CONFIG.PCW_M_AXI_GP0_FREQMHZ {100} CONFIG.PCW_PCAP_PERIPHERAL_CLKSRC {1} \
CONFIG.PCW_PERIPHERAL_BOARD_PRESET {part0} CONFIG.PCW_PRESET_BANK1_VOLTAGE {LVCMOS 1.8V} \
...
CONFIG.PCW_SDIO_PERIPHERAL_VALID {1} CONFIG.PCW_S_AXI_HP1_FREQMHZ {100} \
CONFIG.PCW_TPIU_PERIPHERAL_CLKSRC {IO PLL} CONFIG.PCW_TTC0_PERIPHERAL_ENABLE {1} \
...
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY0 {0.41} CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY1 {0.411} \
CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY2 {0.341} CONFIG.PCW_UIPARAM_DDR_BOARD_DELAY3 {0.358} \
CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_0 {0.025} CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_1 {0.028} \
CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_2 {-0.009} CONFIG.PCW_UIPARAM_DDR_DQS_TO_CLK_DELAY_3 {-0.061} \
CONFIG.PCW_UIPARAM_DDR_FREQ_MHZ {533.333313} CONFIG.PCW_UIPARAM_DDR_PARTNO {MT41J128M16 HA-15E} \
...
CONFIG.PCW_USE_FABRIC_INTERRUPT {1} CONFIG.PCW_USE_S_AXI_HP0 {0} \
CONFIG.PCW_USE_S_AXI_HP1 {1}  ] $processing_system7_1
  ...
  connect_bd_intf_net -intf_net CLReceive_0_M00_AXIS [get_bd_intf_pins CLReceive_0/M00_AXIS] [get_bd_intf_pins axis_data_fifo_1/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_S2MM [get_bd_intf_pins axi_dma_2/M_AXI_S2MM] [get_bd_intf_pins axi_mem_intercon_1/S00_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_1_m00_axi [get_bd_intf_pins axi_mem_intercon_1/M00_AXI] [get_bd_intf_pins processing_system7_1/S_AXI_HP1]
  ...
  connect_bd_intf_net -intf_net processing_system7_1_axi_periph_M00_AXI [get_bd_intf_pins axi_dma_2/S_AXI_LITE] [get_bd_intf_pins processing_system7_1_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_1_axi_periph_M01_AXI [get_bd_intf_pins CLReceive_0/S00_AXI] [get_bd_intf_pins processing_system7_1_axi_periph/M01_AXI]
  ...
  connect_bd_net -net CLReceive_0_CC [get_bd_ports O2_CC] [get_bd_pins CLReceive_0/CC]
  connect_bd_net -net CLReceive_0_LED [get_bd_ports LED] [get_bd_pins CLReceive_0/LED]
  connect_bd_net -net CLReceive_0_SER_OUT [get_bd_ports G_SERTC] [get_bd_pins CLReceive_0/SER_OUT]
  connect_bd_net -net G_SERFC_1 [get_bd_ports G_SERFC] [get_bd_pins CLReceive_0/SER_IN]
  connect_bd_net -net O2_CLK_1 [get_bd_ports O2_CLK] [get_bd_pins CLReceive_0/CLK_O] [get_bd_pins CLReceive_0/m00_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins proc_sys_reset1/slowest_sync_clk]
  connect_bd_net -net O2_D_1 [get_bd_ports O2_D] [get_bd_pins CLReceive_0/DATA_O]
  connect_bd_net -net SW_1 [get_bd_ports SW] [get_bd_pins CLReceive_0/SW]
  connect_bd_net -net axi_dma_2_s2mm_introut [get_bd_pins axi_dma_2/s2mm_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net proc_sys_reset1_peripheral_aresetn [get_bd_pins CLReceive_0/CC_ARESET] [get_bd_pins CLReceive_0/m00_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins proc_sys_reset1/peripheral_aresetn]
  connect_bd_net -net proc_sys_reset_interconnect_aresetn [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins proc_sys_reset/interconnect_aresetn] [get_bd_pins processing_system7_1_axi_periph/ARESETN]
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_pins CLReceive_0/s00_axi_aresetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axis_data_fifo_1/m_axis_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins processing_system7_1_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_1_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_1_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_1_fclk_clk0 [get_bd_pins CLReceive_0/s00_axi_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_1_axi_periph/ACLK] [get_bd_pins processing_system7_1_axi_periph/M00_ACLK] [get_bd_pins processing_system7_1_axi_periph/M01_ACLK] [get_bd_pins processing_system7_1_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_1_fclk_reset0_n [get_bd_pins proc_sys_reset/ext_reset_in] [get_bd_pins proc_sys_reset1/ext_reset_in] [get_bd_pins processing_system7_1/FCLK_RESET0_N]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_1/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces axi_dma_2/Data_S2MM] [get_bd_addr_segs processing_system7_1/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_1_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs CLReceive_0/S00_AXI/S00_AXI_reg] SEG_CLReceive_0_S00_AXI_reg
  create_bd_addr_seg -range 0x10000 -offset 0x40410000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs axi_dma_2/S_AXI_LITE/Reg] SEG_axi_dma_2_Reg
